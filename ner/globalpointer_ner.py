...
# 这里面需要注意的是加入了旋转位置编码，具体可以看苏剑林博客及源码
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if f1 >= self.best_val_f1:
            self.best_val_f1 = f1
            model.save_weights('../checkpoint/ner/best_model_peopledaily_globalpointer.weights')
        print(
...
if __name__ == '__main__':
    ...
    if do_predict:
      model.load_weights('../checkpoint/ner/best_model_peopledaily_globalpointer.weights')
      predict(valid_data)
